# SCV Instagram v170 custody record (2026-09-12)

v170 is v169 plus one correction found in production: a SHORT turn written in Hangul now switches
the thread language. The short-turn guard exists for lexically ambiguous tokens — `ok`, `si`, `no`
belong to several languages — but Hangul is decided by the writing system and cannot be English,
French or Spanish. Before this fix a client who opened in English and then wrote `야, 뭐 하냐?` was
answered in English. Short Latin turns are still guarded exactly as before.

v170 replies in the language the client writes. English stays English; French,
...
| field | value |
| --- | --- |
| release id | `scv-instagram-single-20260912-v170` |
| content fingerprint | `59902c60578a25ffb6c9c1027e56f2e68460abd3047afbf17bdb1725464ab406` |
| release manifest sha256 | `a055f62184e6f8963fd7aab017f0aa16d633b9abe82669bf60db601d2f1284d5` |
| base | `scv-instagram-single-20260911-v169` |
...
| production deployment | `68a36bda-6d8d-4bbc-837c-60d6abc5e7bd` |
| runtime archive (R2) | `scv-instagram-automation/release-ready/20260912T044433Z/v170/scv-instagram-single-20260912-v170-client-language-matching-r2.tar.gz` sha256 `6d70179a68e82e52fbf686d698100a93a4e85055e65e4b4e8bde4efe8022640b` (1597116 bytes, readback byte-identical) |
...
fingerprint and release manifest — to v170. The v167 recovery point and its
