...
// double-check detector must never fuse bubbles from different assistant replies.
{
  ...
  const realBlock = [U('x', 'Omar System 4155550199'), A('y', 'Name : Omar System'), A('y', 'Phone Number : 4155550199'), A('y', 'Appointment date : sept 12'), A('y', 'Time : 2pm'), A('y', 'can you give this a quick look and make sure it\'s all right? 🖤'), U('z', 'ok')]
...
// too-early time and an identity revision keep the bare block / their own lanes.
{
  ...
  check('v152_runner_fixed_lane_answers_yes_then_corrected_block',
    ...
    /^Name : Codex extra high\nPhone Number : 1231231234\nAppointment date : .+\nTime : 3pm\n\ncan you give this a quick look and make sure it\'s all right\? 🖤$/.test(fixedBubbles[1]),
