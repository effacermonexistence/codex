...
- Product Python/installer policy: 47 tests and 11 subtests pass, including rollback, busy-work deferral, guard suspension, modern launchd disabled overrides and progressing replay.
