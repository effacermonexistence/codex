const SENTINEL_SCHEMA = 'scv-instagram-drift-sentinel-2026-09-15-v55-v193-running-release-v167-recovery-gold'
...
// v55 (2026-09-15): v193 gives the author its own delivered turns back — every transport-accepted
// assistant message is in the reseeded conversation, so one Instagram account behaves as one
// accumulating session; delivery-truth, booking state and the boundary machinery stay strict.
...
const RELEASE_ID = 'scv-instagram-single-20260914-v193'
const CONTENT_FINGERPRINT = '73c121493edd1516379f74ca35f7a8ed872b713fc932e9075f4722b97d611d47'
const RELEASE_MANIFEST = '126aed2f43279a5b4cefb7ad32abbf34323f69944094bf9a884be08ac582a716'
