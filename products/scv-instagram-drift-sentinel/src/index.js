const SENTINEL_SCHEMA = 'scv-instagram-drift-sentinel-2026-09-17-v60-v198-running-release-v167-recovery-gold'
...
// v60 (2026-09-17): v198 deletes the recovery template from a plain conversation — a verifier exhaustion there can
// no longer ship the line claiming the reply failed to send, a funnel-order verdict adopts the model line instead
// of throwing the turn away, and the author may name the subject of its own current work.
...
const RELEASE_ID = 'scv-instagram-single-20260914-v198'
const CONTENT_FINGERPRINT = 'e2190988c296ba6aa7db72dc9cdb8eab2dd9bd30dee97bde53412fd1cdc3bc70'
const RELEASE_MANIFEST = '46d44d9d407157d331e7c0b356cccf69796b36aa24189566dca1e25822fd3c79'
