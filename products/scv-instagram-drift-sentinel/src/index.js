const SENTINEL_SCHEMA = 'scv-instagram-drift-sentinel-2026-09-15-v54-v192-running-release-v167-recovery-gold'
...
// v54 (2026-09-15): v192 carries the time frame under discussion into an unmarked follow-up (주말 stays 주말),
// reads -ㄹ랬는데 as -려고 했는데, and admits the second red-team account to the code-locked debug identity;
// models, routes, literals stay.
...
const RELEASE_ID = 'scv-instagram-single-20260914-v192'
const CONTENT_FINGERPRINT = '0245517a2e724182703edbef45eb78f599d3831a37f611cbb00b0c49b97944e3'
const RELEASE_MANIFEST = '3270006dd8fd48f6beecec9e9a4036f0a480adcd412acc2c5fd681c3136e49fd'
