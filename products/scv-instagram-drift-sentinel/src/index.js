const SENTINEL_SCHEMA = 'scv-instagram-drift-sentinel-2026-09-17-v59-v197-running-release-v167-recovery-gold'
...
// v59 (2026-09-17): v197 keeps the booking funnel's calendar lock off a plain social turn — a friend asking
// when you are free gets an answer in the owner's voice instead of shop hours, and the lock is unmoved on every
// thread that carries tattoo or booking state, asserted by a differential against the sealed v196 module.
...
const RELEASE_ID = 'scv-instagram-single-20260914-v197'
const CONTENT_FINGERPRINT = '20e68cbc3e2fa4a7b717cf751f2c6de8ea8733cb32dfc03f6f8049f5bd8257b4'
const RELEASE_MANIFEST = '6e699cc6118ba2ff987ad3ca8712e43fbeb2bf050105cf1ce09f12783d253da0'
