const SENTINEL_SCHEMA = 'scv-instagram-drift-sentinel-2026-09-14-v44-v183-running-release-v167-recovery-gold'
...
// v44 (2026-09-14): v183 makes the owner lead the social conversation (a passive self-report right after
// a passive turn is re-authored with a lead) and renders every deterministic line in any client language
// through the bounded translator; the v180-v182 laws, identity, booking/delivery state and routing stay.
...
const RELEASE_ID = 'scv-instagram-single-20260914-v183'
const CONTENT_FINGERPRINT = '6fe861b48bd12aedb02306b64f4a3d461dcc94722ecbfdf8211edf1ce92b5a4c'
const RELEASE_MANIFEST = '0e93b11cbfc308e6c62dbe5c9965a4b51400cd30a5ac1ff1f8e441397562304f'
