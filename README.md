...
macOS's Fn emoji action; sets the desktop to pure `#000000`;
...
settings window is open; closing that window returns it to the menu bar. The
Always On assertion applies while the user is logged in and the lid is open.
Handy microphone and Accessibility permissions
